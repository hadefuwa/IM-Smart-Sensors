  ...
  return `
    <div id="learn-chapter-map" class="learn-view">
      <div class="max-w-4xl mx-auto relative">
        ...
        <header class="flex items-center gap-3 px-4 py-2 rounded-xl bg-primary/10 border border-primary/20">
          <span class="badge badge-primary badge-outline font-mono text-xs shrink-0">LEARN</span>
          <h1 class="text-base font-bold text-base-content tracking-tight truncate">Smart Sensors &amp; Industry 4.0</h1>
        </header>
