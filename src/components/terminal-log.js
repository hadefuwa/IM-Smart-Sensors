    ...
    this.container.innerHTML = `
      <div class="terminal-log-wrapper h-full flex flex-col">
        ...
        <div class="terminal-header bg-base-300 px-3 py-2 flex items-center justify-between border-b border-base-content/20">
          ...
          <div class="flex items-center gap-2">
            <!-- Filter dropdown -->
            <select id="terminal-filter" class="select select-xs select-bordered">
            ...
            <!-- Auto-scroll toggle -->
            <button id="terminal-autoscroll" class="btn btn-xs btn-ghost" title="Auto-scroll">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
              </svg>
            </button>
            <!-- Clear button -->
            <button id="terminal-clear" class="btn btn-xs btn-ghost" title="Clear log">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
            </button>
            <!-- Export button -->
            <button id="terminal-export" class="btn btn-xs btn-ghost" title="Export to CSV">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
